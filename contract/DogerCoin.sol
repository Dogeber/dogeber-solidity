...
contract DogerCoin is Context, IERC20, Ownable {
    ...
    uint MAX_TAX_LIMIT = 20;
    uint MIN_TAX_LIMIT = 1;
    ...
    //5,000,000,000
    uint256 private _totalSupply = 5000000000 * 10 ** _decimals;   //5 Billion
    //50,000,000
    ...
    constructor () {
        ...
        isExcludedFromFee[EcologicalWalletAddress] = true;
        ...
        isWalletLimitExempt[EcologicalWalletAddress] = true;
        isWalletLimitExempt[address(uniswapPair)] = true;
        isWalletLimitExempt[address(this)] = true;

        isBuyLimitExempt[EcologicalWalletAddress] = true;
        isBuyLimitExempt[address(this)] = true;

        isSellLimitExempt[EcologicalWalletAddress] = true;
        isSellLimitExempt[address(this)] = true;

        isMarketPair[address(uniswapPair)] = true;

        transferOwnership(EcologicalWalletAddress);
        _balances[EcologicalWalletAddress] = _totalSupply;
        emit Transfer(address(0), EcologicalWalletAddress, _totalSupply);
    }
